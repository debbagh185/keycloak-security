...
public class SecurityController {
    ...
    @GetMapping("/profile")
    public String changePassword(RedirectAttributes redirectAttributes, HttpServletRequest request, HttpServletResponse response) {
        ...
        return "redirect:"+keycloakDeployment.getAccountUrl();
    }
